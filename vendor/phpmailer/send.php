...
$email_pengirim = 'jafarsidiks1@gmail.com'; // Isikan dengan email pengirim
$nama_pengirim = ''; // Isikan dengan nama pengirim
...
$mail->Password = 'lgzvvuejlqoibzvg'; // Isikan dengan Password email pengirim
$mail->Port = 465;
$mail->SMTPAuth = true;
$mail->SMTPSecure = 'ssl';
...
$mail->Subject = $subjek;
$mail->Body = $content;
$mail->AddEmbeddedImage('image/logo.png', 'logo_situs', 'logo.png'); // Aktifkan jika ingin menampilkan gambar dalam email
